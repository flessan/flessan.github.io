...
![Version](https://img.shields.io/badge/version-6.3-blue?style=for-the-badge)
...
- **Digital Clock**
  ...
  - Displays weekday, month, and year  
...
| **Calendar** | Full month navigation (Prev / Today / Next) |
| **World Clock** | Live time in New York, London, Tokyo, Sydney |
| **Statistics** | Tracks Pomodoros, alarms, total focus time |
